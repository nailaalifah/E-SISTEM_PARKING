...
.card { flex: 1; background: #F2EDC2; padding: 20px; border-radius: 15px; text-align: center; position: relative; }
.card-icon { position: absolute; right: 15px; top: 15px; background: #FFDE42; padding: 8px; border-radius: 8px; }
.angka { font-size: 30px; color: orange; }
